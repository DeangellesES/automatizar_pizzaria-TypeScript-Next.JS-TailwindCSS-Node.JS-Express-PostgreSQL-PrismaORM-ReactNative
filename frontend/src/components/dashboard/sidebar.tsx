        ...
        <aside className='hidden lg:flex flex-col h-screen w-64 border-r border-app-border bg-app-sidebar'>
            ...
            <div className='border-b border-app-border p-6'>
                <h2 className='text-xl font-bold text-white'>
                    Pizza<span className='text-brand-primary'>ria</span>
                </h2>
                <p className='text-sm text-gay-300 mt-1'>Olá, {userName}</p>
            </div>
                ...
                {menuItems.map((menu) => {
                    ...
                    return (
                        <Link
                            ...
                            key={menu.title}
                            className={cn(
                                'flex items-center gap-3 px-3 py-2 text-sm rounded-md font-medium trasition-colors duration-300',
